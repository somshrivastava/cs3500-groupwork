...
import calendar.controller.SmartController;
...
public class CalendarApp2 {
  ...
  public static void main(String[] args) {
    ...
    // could be new view or use same view?
    ICalendarController smartController = new SmartController(controller, new CalendarView(System.out));
    smartController.execute();
  }
  ...
  private static ICalendarController createController(String mode, String[] args) {
    // TODO: decide what to call for model here, and if final fields should not be final anymore
    ICalendarModel calendarModel = new CalendarModel(); // or should pass in null for now?
