...
/**
 * Comprehensive test suite for CalendarView.
...
public class CalendarViewTest {
    ...
    @Test
    public void testEventFormattingLongSubject() {
        String longSubject = "This is a very long meeting subject that might wrap around multiple lines and should be handled properly by the view formatting system";
        IEvent event = Event.getBuilder()
                .subject(longSubject)
                .startDateTime(baseDateTime)
                .endDateTime(endDateTime)
